...
//     const quizUrl=`${process.env.REACT_APP_FRONTEND_URL}playQuiz/${quiz?._id}`;
...
//           <div>
//             <input type="text" value={`${window.location.origin}/quiz/${quizId}`} className={styles.quiz_url_input} readOnly />
//           </div>
